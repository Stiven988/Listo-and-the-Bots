...
vetomo.on("guildMemberAdd", async (member) => {
    ...
    const noteworthyChannels  = [
        ...
        },
        {
            ...
            text: "Puedes hacer amistades mucho mas estrechas mediante los chats de voz o tambien si no tienes amigos :( puedes escuchar música mediante el obispo Andre"
        },
        {
            emoji: "¿",
            title: "Tienda",
